...
type QuestionServiceClient interface {
	GetQuestion(ctx context.Context, in *GetQuestionReq, opts ...grpc.CallOption) (*QuestionRes, error)
...
func (c *questionServiceClient) GetQuestion(ctx context.Context, in *GetQuestionReq, opts ...grpc.CallOption) (*QuestionRes, error) {
	out := new(QuestionRes)
...
func (x *questionServiceGetProfileQuestionsClient) Recv() (*QuestionRes, error) {
	m := new(QuestionRes)
...
type QuestionServiceServer interface {
	GetQuestion(context.Context, *GetQuestionReq) (*QuestionRes, error)
...
func (UnimplementedQuestionServiceServer) GetQuestion(context.Context, *GetQuestionReq) (*QuestionRes, error) {
...
func (x *questionServiceGetProfileQuestionsServer) Send(m *QuestionRes) error {
