...
type ProfileServiceClient interface {
	GetProfile(ctx context.Context, in *GetProfileReq, opts ...grpc.CallOption) (*ProfileRes, error)
	DeleteProfile(ctx context.Context, in *DeleteProfileReq, opts ...grpc.CallOption) (*emptypb.Empty, error)
	UpdateProfile(ctx context.Context, in *UpdateProfileReq, opts ...grpc.CallOption) (*ProfileRes, error)
	CreateProfile(ctx context.Context, in *CreateProfileReq, opts ...grpc.CallOption) (*ProfileRes, error)
}
...
func (c *profileServiceClient) GetProfile(ctx context.Context, in *GetProfileReq, opts ...grpc.CallOption) (*ProfileRes, error) {
	out := new(ProfileRes)
...
func (c *profileServiceClient) UpdateProfile(ctx context.Context, in *UpdateProfileReq, opts ...grpc.CallOption) (*ProfileRes, error) {
	out := new(ProfileRes)
...
func (c *profileServiceClient) CreateProfile(ctx context.Context, in *CreateProfileReq, opts ...grpc.CallOption) (*ProfileRes, error) {
	out := new(ProfileRes)
...
type ProfileServiceServer interface {
	GetProfile(context.Context, *GetProfileReq) (*ProfileRes, error)
	DeleteProfile(context.Context, *DeleteProfileReq) (*emptypb.Empty, error)
	UpdateProfile(context.Context, *UpdateProfileReq) (*ProfileRes, error)
	CreateProfile(context.Context, *CreateProfileReq) (*ProfileRes, error)
...
func (UnimplementedProfileServiceServer) GetProfile(context.Context, *GetProfileReq) (*ProfileRes, error) {
...
func (UnimplementedProfileServiceServer) UpdateProfile(context.Context, *UpdateProfileReq) (*ProfileRes, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateProfile not implemented")
}
func (UnimplementedProfileServiceServer) CreateProfile(context.Context, *CreateProfileReq) (*ProfileRes, error) {
